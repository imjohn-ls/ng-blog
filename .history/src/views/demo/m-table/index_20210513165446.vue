  ...
  <div>
    <el-form :model="form" ref="form" :rules="rules" class="ui-query-form table-form" label-width="150px" key="1">
        ...
        <el-form-item label="贴现利率" prop="discountRate">
          <el-input v-model="form.discountRate" maxlength="5" οnkeyup="value=value.replace(/[^\d{1,}\.\d{1,}|\d{1,}]/g,'')">
        ...
        <el-form-item label="付息方式" prop="payInterestMethod">
          <el-select v-model="form.payInterestMethod" placeholder="请选择">
            <el-option v-for="(item, index) in payMethodList" :value="item.value" :label="item.label" :key="index"></el-option>
          </el-select>
        </el-form-item>
    ...
    <div v-loading="loading">
      <p>sfdsfsdfdsfdsfdsfsdfdsfsdfdsf</p>
      <p>sfdsfsdfdsfdsfdsfsdfdsfsdfdsf</p>
      <p>sfdsfsdfdsfdsfdsfsdfdsfsdfdsf</p>
      <p>sfdsfsdfdsfdsfdsfsdfdsfsdfdsf</p>
      <p>sfdsfsdfdsfdsfdsfsdfdsfsdfdsf</p>
  ...
  data() {
    return {
      form: {
        ...
        openRansonDate: '',
        endRansonDate: '',
        payInterestMethod: '02',
        pasteInPerNo: '0',
        pasteInBankNo: '',
        pasteInBankName: '',
        contractNo: '',
        invoiceNo: '',
        discountInBankNo: '323596001013',
        discountInAcNo: '',
        remark: '',
        onlineClearFlag: 'SM01',
        onlineClear: '线下清算'
      },
      payMethodList
      tableData1: [
